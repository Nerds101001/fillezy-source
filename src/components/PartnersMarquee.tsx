...
const partners = [
    ...
    { name: "SNAPDEAL", id: "P-02", logo: "/logos/clients/snapdeal.svg" },
    { name: "NYKAA", id: "P-03", logo: "/logos/clients/nykaa.svg" },
    { name: "DELHIVERY", id: "P-04", logo: "/logos/clients/delhivery.svg" },
    { name: "DHL", id: "P-05", logo: "/logos/clients/dhl.svg" },
    { name: "HEALTHKART", id: "P-06", logo: "/logos/clients/healthkart.png" },
    { name: "LIFESTYLE", id: "P-07", logo: "/logos/clients/lifestyle.svg" },
    { name: "SAFE SHOP", id: "P-08", logo: "/logos/clients/safe-shop.svg" },
    ...
    { name: "PURPLLE", id: "P-12", logo: "/logos/clients/purplle.svg" },
    { name: "PEPPERFRY", id: "P-13", logo: "/logos/clients/pepperfry.svg" },
    { name: "THE BODY SHOP", id: "P-14", logo: "/logos/clients/the-body-shop.svg" },
    { name: "BATH & BODY WORKS", id: "P-15", logo: "/logos/clients/bath-and-body-works.svg" },
    { name: "BAGZONE", id: "P-16", logo: "/logos/clients/bagzone.svg" },
    { name: "ADITYA BIRLA", id: "P-17", logo: "/logos/clients/aditya-birla.svg" },
    { name: "KHADI ESSENTIALS", id: "P-18", logo: "/logos/clients/khadi-essentials.svg" },
    { name: "LOUIS PHILIPPE", id: "P-19", logo: "/logos/clients/louis-philippe.svg" },
    { name: "VLCC", id: "P-20", logo: "/logos/clients/vlcc.svg" },
    { name: "VICTORIA'S SECRET", id: "P-21", logo: "/logos/clients/victorias-secret.svg" },
    { name: "CHARLES & KEITH", id: "P-22", logo: "/logos/clients/charles-and-keith.svg" },
    { name: "ALDO", id: "P-23", logo: "/logos/clients/aldo.svg" },
    { name: "SERVOTEC", id: "P-24", logo: "/logos/clients/servotec.svg" },
    { name: "CATERPILLAR", id: "P-25", logo: "/logos/clients/caterpillar.svg" },
    { name: "BOSCH", id: "P-26", logo: "/logos/clients/bosch.svg" },
    { name: "SMC", id: "P-27", logo: "/logos/clients/smc.svg" },
    { name: "SKF", id: "P-28", logo: "/logos/clients/skf.svg" },
    { name: "THERMO KING", id: "P-29", logo: "/logos/clients/thermo-king.svg" },
    { name: "MITUTOYO", id: "P-30", logo: "/logos/clients/mitutoyo.svg" },
    { name: "HONDA", id: "P-31", logo: "/logos/clients/honda.svg" },
    { name: "EATON", id: "P-32", logo: "/logos/clients/eaton.svg" },
    { name: "MAN", id: "P-33", logo: "/logos/clients/man.svg" },
];
