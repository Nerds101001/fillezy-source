    ...
    return (
        <div className="bg-white selection:bg-primary selection:text-white">
            ...
            <main className="isolate min-h-screen">
                ...
                <div className="bg-[#F8F8F9] pt-64 pb-32 relative overflow-hidden border-b border-black/[0.03]">
                        ...
                        <div className="lg:flex lg:items-end lg:justify-between">
                            <div className="max-w-3xl">
                                <motion.h1
                                    ...
                                    className="text-7xl font-black tracking-tighter text-foreground sm:text-9xl uppercase leading-[0.85] mb-8"
                                >
                                ...
                                <motion.p
                                    ...
                                    className="text-xl text-foreground/50 font-medium leading-relaxed max-w-xl"
                                >
                            ...
                            <motion.div
                                ...
                                className="mt-12 lg:mt-0 flex gap-12 border-l border-black/5 pl-12"
                            >
                                <div>
                                    <span className="block text-[10px] font-mono font-black text-black/20 uppercase tracking-widest mb-1">AVAILABLE_SYSTEMS</span>
                                    <span className="text-4xl font-black text-foreground">{products.length.toString().padStart(2, '0')}</span>
                                </div>
                                <div>
                                    <span className="block text-[10px] font-mono font-black text-black/20 uppercase tracking-widest mb-1">DEPLOYMENT_READY</span>
                                    <span className="text-4xl font-black text-primary italic font-serif leading-none">Global</span>
                                </div>
                            </motion.div>
                        </div>
                    </div>
                ...
                <section className="mx-auto max-w-7xl px-6 pb-24 lg:px-8">
                    <div className="bg-black rounded-[3rem] p-12 lg:p-20 relative overflow-hidden text-center group">
                        ...
                        <div className="relative z-10 max-w-2xl mx-auto">
                            <h2 className="text-4xl lg:text-6xl font-black text-white uppercase tracking-tighter mb-8">
                            ...
                            <Link
                                href="/contact"
                                className="inline-flex items-center gap-4 rounded-2xl bg-primary px-10 py-6 text-[10px] font-mono font-black uppercase tracking-[0.3em] text-white hover:bg-white hover:text-primary transition-all shadow-2xl shadow-primary/20"
                            >
