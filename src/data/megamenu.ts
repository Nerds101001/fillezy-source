...
export const megamenuData: MegamenuCategory[] = [
    {
        ...
        products: [
            { id: "hexa-machine", name: "Fillezy® Hexa Paper Machine", techId: "HEX-M0", image: "/product/Fillezy-Paper-Machine.webp", href: "/products/hexa-machine" },
    ...
    },
    {
        ...
        products: [
            ...
            { id: "paper-aer", name: "Fillezy® Paper Aer", techId: "AER-P6", image: "/product/Fillezy-Paper-Aer.webp", href: "/products/paper-aer" },
    ...
    },
    {
        ...
        products: [
            ...
            { id: "movable-bins", name: "Fillezy® Movable Bins", techId: "INT-M3", image: "/product/FIlezy Handling Systems.webp", href: "/products/movable-bins" },
            { id: "winders", name: "Fillezy® Industrial Winders", techId: "INT-W4", image: "/product/FIlezy Handling Systems.webp", href: "/products/winders" }
        ]
    }
];
